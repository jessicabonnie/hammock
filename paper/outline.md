...
- **Figure 6 parameter choice for the Results prose:** k=10, w=30 is the ARI-optimal sequence-mode setting under the inclusion–exclusion estimator at the displayed default precision p=18, and the same optimum and ten-cluster partition persist across every tested precision p=12–24; the parameter sweep, rather than Figure 6 itself, is the evidence for that choice.
