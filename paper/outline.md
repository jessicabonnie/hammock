...
Although the maximum-ARI configuration produced the same ten-cluster partition at p=12, p=18, and p=24 (ARI=0.910; NMI=0.961), the complete dendrogram changed across precisions (Figure 8). Thus, partition-level metrics can mask variation in within- and between-cluster hierarchical relationships.
