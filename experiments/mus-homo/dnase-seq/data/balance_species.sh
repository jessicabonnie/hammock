...
# =============================================================================
# DNase-seq Species Balancing Script
# =============================================================================
#
# PURPOSE:
...
# 5. Randomly selects that minimum number of samples from each species
...
# Usage: ./balance_species.sh input_file output_file
...
while read tissue; do
    ...
    tail -n +2 "$INPUT_FILE" | awk -F'\t' -v tissue="$tissue" '$4 == tissue && $5 == "Homo sapiens"' | \
        shuf | head -n "$min_count" >> "$TEMP_DIR/balanced_samples.txt"
